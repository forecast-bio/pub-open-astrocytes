...
first_image = first_movie_frames[0].image[0]
...
with HouseStyle() as s:
    ...
    ax_xticks.set_xticks(
        ...
        ['0', f'{first_movie_frames[0].scale_x * patch_size_x:0.0f} µm'],
        ha = 'left',
    )
...
causal_offset = (PC_WINDOW * dt) * CAUSAL_OFFSET_FRACTION
...
with HouseStyle( grids = True ) as s:
    ...
    for i_patch in range( n_patches ):
        ...
        for i_seq, (cur_pc, cur_color) in enumerate(
            ...
            ax.plot( t_rel[filter_plot], pc_values_norm,
                f'{cur_color}-',
                label = f'PC {cur_pc + 1}',
            )
