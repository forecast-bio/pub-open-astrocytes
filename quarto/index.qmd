...
# TODO Unfortunately, the shuffling mechanism in WebDataset at the core of
# this routine means that we can't avoid nondeterminism in the data streamed
# in here, leading to intrinsic nondeterminism in the output for this pub;
# this may be avoided in a future `atdata` release supporting `wids` for
# indexed streaming.
...
MODULATION_MIN_CONCENTRATION = 50. #uM
"TODO"
